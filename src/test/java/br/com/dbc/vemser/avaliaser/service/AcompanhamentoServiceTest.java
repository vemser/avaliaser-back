...
//        final int id = 1;
//        final String nomeProg = "Programa";
//        final String tituloAc = "Acompanhamento";
//        final int numeroPagina = 0;
//        final int tamanho = 3;
//
//        AcompanhamentoEntity acompanhamento = AcompanhamentoFactory.getAcompanhamento();
//        PageImpl<AcompanhamentoEntity> listaPaginada = new PageImpl<>(List.of(acompanhamento),
//                PageRequest.of(numeroPagina, tamanho), 0);
//
//        when(acompanhamentoService.filtrarAcompanhamento(id,nomeProg,tituloAc,numeroPagina,tamanho)).thenReturn(listaPaginada);
//        PageDTO<AcompanhamentoDTO> acompanhamentoDTOPageDTO =
//                acompanhamentoService.listarAcompanhamentosPaginados(id, nomeProg, tituloAc, numeroPagina, tamanho);
//
...
//        final int tamanho = -1;
//        acompanhamentoService.listarAcompanhamentosPaginados(1,nomeProg,tituloAc,numeroPagina, tamanho);
//
//    }
//
//    @Test
...
//
//        PageDTO<AcompanhamentoDTO> paginaRecebida = acompanhamentoService.listarAcompanhamentosPaginados(id, nomeProg, tituloAc,numeroPagina, tamanho);
...
//        when(acompanhamentoRepository.save(any())).thenReturn(acompanhamentoEntity);
//
//        AcompanhamentoDTO acompanhamentoDTO = acompanhamentoService.update(acompanhamentoCreateDTO, 1);
//
//        assertNotNull(acompanhamentoDTO);
//    }
//
